...
import { GET_SELF } from './queries'

const UserProfileRegularPage = ({ sm, updateSm, setProfileName }) => {
  const [modalTab, setModalTab] = useState("1");
  const [userInfo, setUserInfo] = useState([]);
  const { loading, error, data } = useQuery(GET_SELF, { onCompleted: parseData })

  function parseData() {
    return setUserInfo(data.self);
  }
        ...
        <div className="nk-data data-list">
          ...
          <div className="data-item" onClick={() => setModal(true)}>
            <div className="data-col">
              ...
              <span className="data-value">{userInfo.id}</span>
            </div>
            <div className="data-col data-col-end">
              <span className="data-more">
                <Icon name="forward-ios"></Icon>
