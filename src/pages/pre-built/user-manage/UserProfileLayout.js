              ...
              <div className="card-inner-group">
                ...
                <div className="card-inner p-0">
                  <ul className="link-list-menu">
                    ...
                    <li onClick={() => updateSm(false)}>
                      <Link
                        to={`${process.env.PUBLIC_URL}/user-profile-password`}
                        className={
                          window.location.pathname === `${process.env.PUBLIC_URL}/user-profile-password` ? "active" : ""
                        }
                      >
                        <Icon name="lock-alt-fill"></Icon>
                        <span>Change Password</span>
                      </Link>
                    </li><li onClick={() => updateSm(false)}>
                      <Link
                        to={`${process.env.PUBLIC_URL}/user-profile-package`}
                        className={
                          window.location.pathname === `${process.env.PUBLIC_URL}/user-profile-package` ? "active" : ""
                        }
                      >
